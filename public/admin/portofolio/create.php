<?php
// public/admin/portofolio/create.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($title === '' || $content === '') {
        $errors[] = 'Judul dan isi portofolio wajib diisi.';
    }
    ...
    if (empty($errors)) {
        ...
        if ($ok) {
            ...
            $errors[] = 'Gagal menyimpan portofolio ke database.';
        }
    }
}
...
<main class="flex-1 p-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-2xl font-semibold mb-4">Buat Portofolio</h1>
