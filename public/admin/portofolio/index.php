    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
            <form method="GET" action="" class="flex gap-2">
                <input type="search" name="q" value="<?= htmlspecialchars($searchQuery) ?>" placeholder="Cari portofolio..." class="px-3 py-3 border rounded w-full md:w-64 text-sm" />
            ...
            <a href="create.php" class="bg-indigo-600 text-white px-4 py-2 rounded text-sm hover:bg-indigo-700">Buat Portofolio</a>
        </div>

        <?php if (count($articles) === 0): ?>
            <div class="bg-white p-6 rounded shadow">Belum ada portofolio.</div>
        <?php else: ?>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-center align-top">
                                    <div class="inline-flex items-center gap-2">
                                        ...
                                        <a href="<?= '../../portofolio.php?slug=' . e($a['slug']) ?>" target="_blank" class="text-gray-600 text-sm px-2 py-1 rounded hover:bg-gray-100">
